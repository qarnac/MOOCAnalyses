...
def d_insert_all_spinoff():
    ...
    cur.execute("SELECT user_id FROM user where id>215")
    ...
    for user_id in results:
        ...
        if user_projects:
            for user_project in user_projects:
                ...
                cur.execute("INSERT INTO all_spinoff (user_id, project_title, url, spinoff_count, parent_id) VALUES (%s,%s,%s,%s,%s)"
                                , (user_id, project_title, user_project[1], user_project[2], "null"))
