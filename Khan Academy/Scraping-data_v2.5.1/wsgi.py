...
<body>
    ...
    <table border=1 id = "background-image">
        <tr><th colspan=5 align = 'center'><font size='12'>Summary</th></tr>
        <tr><th bgcolor = 'yellow'>Total number of account that we collected</th><td colspan=4>%(total_number_account)s</td></tr>
        <tr><th bgcolor = 'yellow'>Total number of project that we collected</th><td colspan=4>%(total_number_project)s</td></tr>
        <tr><th bgcolor = 'yellow'>Total Number of original tutorial</th><td colspan=4>%(total_number_original_tutorial)s</td></tr>
        %(top10_users)s
        %(top10_projects)s
    </table>
</body>
