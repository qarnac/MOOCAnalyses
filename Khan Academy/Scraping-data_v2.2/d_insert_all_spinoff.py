...
def d_insert_all_spinoff():
    ...
    cur.execute("SELECT user_id FROM user where id>242")
    ...
    for user_id in results:
        ...
        if user_projects:
            for user_project in user_projects:
                ...
                url = user_project[1]
                spinoff_count = user_project[2]
                cur.execute("INSERT INTO all_spinoff (user_id, project_title, url, spinoff_count) VALUES (%s,%s,%s,%s)"
                                , (user_id, project_title, url, spinoff_count))
